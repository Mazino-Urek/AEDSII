...
public class Pselecao{
	...
	/*
	 * realiza a troca de de duas posicões em um array de jogadores
	 * @param Jogador[] player - array a ser realizado a troca
	 * @param int n - posição a ser trocada
	 * @param int i - posição a ser trocada
	 * */
	public static void swap (Jogador[] player, int n, int i){

		Jogador aux = player[i];
		player[i] = player[n];
		player[n] = aux;
	...
	/*
	 * ordena parcialmente um array de jogadores pelo nome
	 * @param Jogador[] array - array a ser ordenado
	 * @param int n - tamanho do array
	 * @param int k - tamanho a ser ordenado
	 * */
	public static void selecaoP (Jogador[] array, int n, int k){
	...
	public static void main(String[] args) {
		...
		Arq.openWrite("710678_selecao.txt");
